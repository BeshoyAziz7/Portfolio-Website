...
(function initStackSpread() {
  ...
  alt: "Cinematic Scroll Portfolio",
  stackOX: 6,
  stackOY: 20,
  stackRotate: -8,
  endX: 40,
  ...
  scale: 0.85,
  project: {
    title: "Cinematic Scroll Portfolio",
    category: "Web Development",
    desc: "A hand-built, scroll-driven portfolio that treats scrolling as a camera move — featuring a glyph-portal hero you scroll through, a pinned four-chapter origin story, a draggable skills coverflow, and a scatter-animated project stack, all powered by vanilla JavaScript and GSAP ScrollTrigger with zero frameworks or build tooling.",
    tags: ["HTML5", "CSS3", "JavaScript", "GSAP", "ScrollTrigger"],
    live: "https://beshoyaziz7.github.io/Portfolio-Website/",
    github: "https://github.com/BeshoyAziz7/Portfolio-Website",
  },
},
];
